...
# The ROM to read when doing everything
ROM_DIR = ROOT.joinpath("Mother.nes")

FOLDER_DUMPS = ROOT.joinpath("Dumps")
FOLDER_DATA = ROOT.joinpath("Data")

DIR_RAW_DUMP = FOLDER_DUMPS.joinpath("BattleActions Dump.txt")      # Raw Dump in Binary directory
DIR_DUMP = FOLDER_DUMPS.joinpath("BattleActions.txt")               # Dump in English directory

DIR_BA_DATA = FOLDER_DATA.joinpath("BattleActions.txt")             # File to read when Writing to ROM
